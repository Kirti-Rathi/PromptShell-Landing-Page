  ...
  return (
    ...
    >
      <div className="text-center">
        ...
        <p className="mt-2 relative z-10 max-w-2xl mx-auto text-lg text-gray-300 sm:mt-3">
        ...
        <a
          ...
          className="group bg-background text-foreground relative z-10 mt-6 hover:bg-background/90 px-4 py-1 rounded-lg flex items-center gap-1.5 transition-colors justify-center w-fit mx-auto"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
