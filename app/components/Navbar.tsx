    ...
    <nav className="px-6 py-4">
      <div className="container mx-auto flex items-center justify-between">
        ...
        >
          <Link
            href="/#installation"
            className="transition-colors w-full lg:w-auto text-center"
          >
            Installation
          </Link>
          <Link
          ...
          <a
            ...
            className=" bg-foreground text-background hover:bg-[#292929] px-4 py-2 rounded-lg flex items-center gap-2 transition-colors justify-center w-full lg:w-auto"
          >
            <svg
