      ...
      <div className="container mx-auto flex items-center justify-between">
        ...
        >
          ...
          <LinkPreview
            ...
            className=" bg-foreground animate-glow text-background hover:bg-[#292929] px-4 py-2 rounded-lg flex items-center gap-2 transition-colors justify-center w-full lg:w-auto"
          >
            <svg
